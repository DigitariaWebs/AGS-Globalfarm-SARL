...
const products: Product[] = [
  {
    ...
    unit: "kg",
    image: "/Tomato.png",
    description: "Tomates biologiques, cultivées localement sans pesticides",
    stock: 50,
    organic: true,
    rating: 4.8,
    reviews: 124,
  ...
  {
    id: 2,
    name: "Concombres Biologiques",
    category: "Légumes",
    price: 2000,
    unit: "kg",
    image: "/Pickles.png",
    description: "Concombres frais et croquants, parfaits pour les salades",
    stock: 40,
    organic: true,
    rating: 4.7,
    reviews: 89,
  ...
  {
    id: 3,
    name: "Sacs de Semences Premium",
    category: "Semences",
    price: 5000,
    unit: "sac",
    image: "/Bags.png",
    description: "Semences certifiées de haute qualité pour votre jardin",
    stock: 30,
    organic: true,
    rating: 4.9,
    reviews: 156,
  ...
  {
    id: 4,
    name: "Mix Légumes Biologiques",
    category: "Légumes",
    price: 8500,
    unit: "panier",
    image: "/BlackManWithBags.png",
    description: "Panier varié de légumes frais de saison",
    stock: 20,
    organic: true,
    rating: 5.0,
    reviews: 203,
  },
  {
    ...
    description: "Plants de tomates robustes prêts à planter",
    stock: 100,
    organic: true,
    rating: 4.6,
    reviews: 78,
  ...
  {
    id: 6,
    name: "Semences Maraîchères",
    category: "Semences",
    price: 3000,
    unit: "paquet",
    image: "/BlackManWithBagsTwo.png",
    description: "Assortiment de semences pour culture maraîchère",
    stock: 45,
    organic: true,
    rating: 4.8,
    reviews: 91,
  ...
  {
    id: 7,
    name: "Récolte Premium",
    category: "Légumes",
    price: 12000,
    unit: "panier XL",
    image: "/BlackManExplaining.png",
    description: "Grand panier de légumes variés, idéal pour les familles",
    stock: 15,
    organic: true,
    rating: 4.9,
    reviews: 167,
  ...
  {
    id: 8,
    name: "Pack Démarrage Jardin",
    category: "Semences",
    price: 7500,
    unit: "pack",
    image: "/BlackManExplainingTwo.png",
    description: "Kit complet de semences pour débuter votre jardin",
    stock: 25,
    organic: true,
    rating: 4.7,
    reviews: 134,
      ...
      <section className="relative pt-28 pb-32 overflow-hidden bg-emerald-900">
        ...
        <div className="absolute bottom-0 left-0 w-full overflow-hidden leading-none rotate-180">
          <svg
            ...
            preserveAspectRatio="none"
            className="relative block w-[calc(100%+1.3px)] h-[60px] fill-[#FDFBF7]"
          >
